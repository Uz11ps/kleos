    ...
    private func sendMessage() {
        ...
        Task {
            do {
                ...
                loadMessages() // Reload to get all messages including the new one
            } catch {
                // Handle error - можно добавить показ ошибки пользователю
                await MainActor.run {
                    self.newMessage = messageText // Вернуть текст обратно при ошибке
                }
            }
        }
    }
