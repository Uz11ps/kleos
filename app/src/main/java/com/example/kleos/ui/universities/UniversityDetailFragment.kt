...
import com.example.kleos.databinding.FragmentUniversityDetailBinding
...
class UniversityDetailFragment : Fragment() {
    ...
    private fun displayUniversity(
        ...
        website: String,
        logoUrl: String,
        socialLinks: com.example.kleos.data.network.SocialLinksDto?,
        degreePrograms: List<com.example.kleos.data.network.DegreeProgramDto>?
    ) {
            ...
            viewLifecycleOwner.lifecycleScope.launch(Dispatchers.IO) {
                try {
                    val fullUrl = if (logoUrl.startsWith("http")) logoUrl else {
                        "${com.example.kleos.BuildConfig.API_BASE_URL}${logoUrl.removePrefix("/")}"
                    }
