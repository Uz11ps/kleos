package com.kleos.education.ui.verify
...
import com.kleos.education.data.network.AuthApi
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                com.kleos.education.utils.FcmTokenManager.registerToken(this@VerifyDeepLinkActivity)
