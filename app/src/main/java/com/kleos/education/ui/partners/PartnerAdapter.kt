...
import com.kleos.education.data.network.PartnerDto
import com.kleos.education.databinding.ItemPartnerBinding
...
class PartnerAdapter(
    ...
    override fun onBindViewHolder(holder: PartnerViewHolder, position: Int) {
        ...
        holder.binding.categoryText.text = holder.itemView.context.getString(com.kleos.education.R.string.category_partners)
