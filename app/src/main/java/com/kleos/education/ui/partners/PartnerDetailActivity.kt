...
import com.kleos.education.databinding.ActivityPartnerDetailBinding
...
class PartnerDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        window.statusBarColor = resources.getColor(com.kleos.education.R.color.onboarding_background, null)
    ...
    override fun onDestroy() {
        ...
        window.statusBarColor = resources.getColor(com.kleos.education.R.color.dark_background, null)
    }
}
